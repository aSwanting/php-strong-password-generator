...
<body class="bg-dark bg-gradient bg-opacity-75 vh-100 overflow-hidden">
    ...
    <div class="container bg-white border rounded rounded-5 p-5 my-5 shadow text-center">
        <h1 class="text-uppercase fw-semibold display-5 mb-5">Generated Password</h1>
